...
O arquivo `render.yaml` na raiz registra os mesmos valores sem incluir segredos. Um pacote de campanha continua opcional por meio do par `CAOS_VTT_CAMPAIGN_MANIFEST` e `CAOS_VTT_CAMPAIGN_ROOT`; nenhum pacote específico é enviado no deploy padrão.
