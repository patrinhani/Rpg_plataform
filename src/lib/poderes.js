...
const poderesParanormais = [
    // Sem Elemento
    {
        ...
        tipo: "Paranormal",
        prerequisito: "NEX 10%",
        descricao: "Aprende e pode conjurar um ritual de 1º círculo à sua escolha (até 2º círculo em NEX 45%, até 3º círculo em NEX 75%). Pode substituir um ritual que já conhece. Conta como poder do elemento do ritual escolhido. Afinidade: Você pode escolher este poder mais vezes, estando sujeito ao limite de rituais conhecidos.",
    },
{
        key: "resistir_elemento",
        nome: "Resistir a Elemento",
        elemento: "Varia",
        tipo: "Paranormal",
        prerequisito: "NEX 10%",
        descricao: "Escolha um elemento (Conhecimento, Energia, Morte ou Sangue). Você recebe resistência 10 contra esse elemento. Conta como poder do elemento escolhido. Afinidade: Aumenta a resistência para 20.",
        requiresChoice: 'elemento', // <-- NOVO: Requer escolha
    },
    // Sangue
    {
        key: "espreitar_da_besta",
        nome: "Espreitar da Besta",
        elemento: "Sangue",
        tipo: "Paranormal",
        prerequisito: "NEX 10%",
        descricao: "Você recebe +5 em Furtividade. Em cenas de perseguição (caçador), pode usar Furtividade em vez de Atletismo. Em cenas de furtividade, não sofre penalidade de –O para ações discretas. Afinidade: O bônus em Furtividade aumenta para +10.",
    },
    {
        key: "instintos_sanguinarios",
        nome: "Instintos Sanguinários",
        elemento: "Sangue",
        tipo: "Paranormal",
        prerequisito: "NEX 10%",
        descricao: "Você recebe visão no escuro e faro. Afinidade: Não pode mais ser flanqueado, não fica desprevenido e recebe +5 em testes de resistência contra armadilhas da realidade ou paranormais.",
    },
    {
        key: "anatomia_insana",
        ...
        descricao: "Você tem 50% de chance (resultado par em 1d4) de ignorar o dano adicional de um acerto crítico ou ataque furtivo. Afinidade: Você é imune aos efeitos de acertos críticos e ataques furtivos.",
    },
    {
        key: "arma_de_sangue",
        nome: "Arma de Sangue",
        ...
        tipo: "Paranormal",
        prerequisito: "NEX 10%",
        descricao: "Ação de movimento e 2 PE: Produz garras/chifres/lâmina de sangue (arma simples leve, 1d6 dano de Sangue). 1 PE/turno: Ataque corpo a corpo adicional (1x/turno). Dura até o fim da cena. Afinidade: A arma se torna permanente e causa 1d10 pontos de dano de Sangue.",
    },
    {
        key: "sangue_de_ferro",
        ...
        tipo: "Paranormal",
        prerequisito: "NEX 10%",
        descricao: "Você recebe +2 PV por NEX. O PV recebido por NEX aumenta a cada aumento. Afinidade: Você recebe +5 em Fortitude e se torna imune a venenos e doenças.",
    },
    {
        key: "sangue_fervente",
        ...
        tipo: "Paranormal",
        prerequisito: "Sangue 2",
        descricao: "Enquanto estiver machucado, você recebe +1 em Agilidade ou Força (à sua escolha, ativado no momento). Afinidade: O bônus aumenta para +2.",
    },
    {
        key: "sangue_vivo",
        nome: "Sangue Vivo",
        ...
        descricao: "Na primeira vez que ficar machucado durante a cena, você recebe Cura Acelerada 2 até o fim da cena (não cura acima da metade dos PV máx). Afinidade: A Cura Acelerada aumenta para 5.",
    },
    // Morte
    {
        key: "antecipar_vitalidade",
        nome: "Antecipar Vitalidade",
        elemento: "Morte",
        tipo: "Paranormal",
        prerequisito: "NEX 10%",
        descricao: "Pode acumular uma carga de antecipação (+O no teste) para cada ponto de Vigor (máx VIG). Na próxima ação dormir, perde 1 carga em vez de recuperar PV. Afinidade: O limite de cargas aumenta em +2 e perde 2 cargas por ação dormir.",
    },
    {
        key: "aura_de_pavor",
        nome: "Aura de Pavor",
        ...
        tipo: "Paranormal",
        prerequisito: "NEX 10%",
        descricao: "Ação de movimento e 2 PE: Deixa 1 pessoa ou animal (alcance médio) apavorado (Vontade DT Pre reduz para abalado). 1x/dia por alvo. Afinidade: A DT para resistir aumenta em +5 e afeta pessoas ou animais escolhidos.",
    },
    {
        key: "encarar_a_morte",
        ...
        tipo: "Paranormal",
        prerequisito: "NEX 10%",
        descricao: "Durante cenas de ação, seu limite de gasto de PE aumenta em +1. Afinidade: O limite de gasto de PE aumenta em +2 (total +3).",
    },
    {
        key: "escapar_da_morte",
        nome: "Escapar da Morte",
        elemento: "Morte",
        tipo: "Paranormal",
        prerequisito: "Morte 1",
        descricao: "1x/cena: Se o dano o levaria a 0 PV, fica com 1 PV (não funciona contra dano massivo). Afinidade: Evita completamente o dano. Contra dano massivo, fica com 1 PV.",
    },
    {
        key: "potencial_aprimorado",
        nome: "Potencial Aprimorado",
        elemento: "Morte",
        tipo: "Paranormal",
        prerequisito: "NEX 10%",
        descricao: "Você recebe +1 PE por NEX. O PE recebido por NEX aumenta a cada aumento. Afinidade: Você recebe +1 PE adicional por NEX (total +2 PE por NEX).",
    },
    {
        key: "potencial_reaproveitado",
        nome: "Potencial Reaproveitado",
        elemento: "Morte",
        tipo: "Paranormal",
        prerequisito: "NEX 10%",
        descricao: "1x/rodada: Ao passar em um teste de resistência, você ganha 2 PE temporários. Desaparecem no final da cena. Afinidade: Você ganha 3 PE temporários.",
    },
    {
        key: "surto_temporal",
        nome: "Surto Temporal",
        ...
        descricao: "1x/cena, durante seu turno: Gasta 3 PE para realizar uma ação padrão adicional. Afinidade: Pode usar este poder 1x/turno.",
    },
    // Conhecimento
    {
        key: "absorver_conhecimento",
        nome: "Absorver Conhecimento",
        elemento: "Conhecimento",
        tipo: "Paranormal",
        prerequisito: "NEX 10%",
        descricao: "Ação completa e 1 PE (empunhando fonte escrita): Faz 1 pergunta à fonte e obtém a resposta (se estiver nela). Usar em interlúdio 'ler' aumenta o dado de bônus em um passo (d6 para d8, etc.). Afinidade: Custo de rituais de Conhecimento (alvo 1 pessoa, exceto você) é reduzido em -1 PE se tocar o alvo.",
    },
    {
        key: "apatia_herege",
        nome: "Apatia Herege",
        ...
        descricao: "Quando faz um teste contra condição de medo, gasta 2 PE para rolar novamente (deve aceitar o novo resultado). Afinidade: Pode usar após saber o resultado e escolher a melhor rolagem.",
    },
    {
        key: "expansao_de_conhecimento",
        nome: "Expansão de Conhecimento",
        elemento: "Conhecimento",
        tipo: "Paranormal",
        prerequisito: "Conhecimento 1",
        descricao: "Você aprende um poder de classe que não pertença à sua classe (cumprindo pré-requisitos). Afinidade: Você aprende um segundo poder de classe que não pertença à sua classe.",
    },
    {
        key: "percepcao_paranormal",
        nome: "Percepção Paranormal",
        elemento: "Conhecimento",
        tipo: "Paranormal",
        prerequisito: "NEX 10%",
        descricao: "Em cenas de investigação: Ao procurar pistas, pode rolar novamente um dado com resultado menor que 10 (deve aceitar o novo resultado). Afinidade: Pode rolar novamente até dois dados com resultado menor que 10.",
    },
    {
        key: "precognicao",
        nome: "Precognição",
        ...
        tipo: "Paranormal",
        prerequisito: "Conhecimento 1",
        descricao: "Você recebe +2 em Defesa e em testes de resistência. Afinidade: Você fica imune à condição desprevenido.",
    },
    {
        key: "sensitivo",
        nome: "Sensitivo",
        ...
        tipo: "Paranormal",
        prerequisito: "NEX 10%",
        descricao: "Você recebe +5 em testes de Diplomacia, Intimidação e Intuição. Afinidade: Quando faz um teste oposto com uma dessas perícias, o oponente sofre menos 1 dado.",
    },
    {
        key: "visao_do_oculto",
        ...
        tipo: "Paranormal",
        prerequisito: "NEX 10%",
        descricao: "Você recebe +5 em testes de Percepção e enxerga no escuro. Afinidade: Você ignora camuflagem.",
    },
    // Energia
    {
        key: "conexao_empatica",
        nome: "Conexão Empática",
        elemento: "Energia",
        tipo: "Paranormal",
        prerequisito: "Energia 1",
        descricao: "Ação completa e 2 PE (tocando objeto elétrico ligado): Conversa com o objeto até o fim da cena. Objeto tem percepção e personalidade limitadas por seus programas/arquivos. Se tentar conversar de novo, fica hostil. Afinidade: Recebe +5 em testes de perícias baseadas em Intelecto ou Presença com o item.",
    },
    {
        key: "valer_se_do_caos",
        nome: "Valer-se do Caos",
        elemento: "Energia",
        tipo: "Paranormal",
        prerequisito: "NEX 10%",
        descricao: "Ao fazer um teste, você pode tentar controlar o caos. Se fizer isso, recebe +O nesse teste. Se o teste for uma falha, ou se o resultado do d20 adicional for igual ou menor que 5, você perde 1d4 pontos de Sanidade. Afinidade: Você perde Sanidade se o teste for uma falha ou se o resultado do O extra for 1 ou 2.",
    },
    {
        key: "afortunado",
        nome: "Afortunado",
        ...
        tipo: "Paranormal",
        prerequisito: "NEX 10%",
        descricao: "1x/rolagem: Pode rolar novamente um resultado 1 em qualquer dado que não seja d20. Afinidade: 1x/teste: Pode rolar novamente um resultado 1 em d20.",
    },
    {
        key: "campo_protetor",
        nome: "Campo Protetor",
        ...
        tipo: "Paranormal",
        prerequisito: "Energia 1",
        descricao: "Ao usar esquiva, gasta 1 PE para receber +5 em Defesa. Afinidade: Recebe +5 em Reflexo e, se passar em Reflexos (dano reduzido à metade), não sofre dano nenhum.",
    },
    {
        key: "causalidade_fortuita",
        nome: "Causalidade Fortuita",
        elemento: "Energia",
        tipo: "Paranormal",
        prerequisito: "NEX 10%",
        descricao: "Em cenas de investigação, a DT para procurar pistas diminui em –5 para você até você encontrar uma pista. Afinidade: A DT para procurar pistas sempre diminui em –5 para você.",
    },
    {
        key: "golpe_de_sorte",
        nome: "Golpe de Sorte",
    ...
    {
        key: "manipular_entropia",
        nome: "Manipular Entropia",
        elemento: "Energia",
        tipo: "Paranormal",
        prerequisito: "Energia 1",
        descricao: "Gasta 2 PE para forçar um alvo (alcance curto, exceto você) a rolar novamente um dado em um teste de perícia. Afinidade: O alvo rola novamente todos os dados que você escolher.",
    }
];
...
export { 
    ...
    poderesOcultista,
    poderesGerais,
    poderesParanormais // <--- NOVO: Exporta a lista
};